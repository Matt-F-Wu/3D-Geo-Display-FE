		...
		for ( Marker country : countryMarkers ){
			...
			for ( Marker quake : quakeMarkers ){
				if ( quake instanceof LandQuakeMarker){
					if( ((LandQuakeMarker)quake).getProperty("country") == country.getProperty("name")){
						num++;
					}
				}
				else if (flag){
			...
			if (num != 0){
				System.out.println(country.getProperty("name") + ": " + num);
			}
			flag = false;
		}
		System.out.println("OCEAN QUAKES: " + ocnum);
	}
